...
const AgentForms = () => {
  ...
  return (
    <View>
      <View
        style={tw`w-full  my-1 flex flex-col justify-start items-start gap-2`}
      >
        <View
          style={tw`w-full flex flex-row justify-between items-center gap-2`}
        >
          <View style={tw`w-[47%]`}>
      ...
      <View style={tw`w-full flex flex-row justify-between items-center gap-2`}>
        <View style={tw`w-[47%]`}>
          <Text style={tw`text-lg font-semibold`}>Agency name</Text>
          <TextInput
            type="text"
            style={tw`w-full font-medium rounded-lg border border-[#70AE76] px-3 py-3`}
        ...
        <View style={tw`w-[50%]`}>
          <Text style={tw`text-lg font-semibold`}>Address</Text>
          <TextInput
            type="text"
            style={tw`w-full font-medium rounded-lg border border-[#70AE76] px-3 py-3`}
